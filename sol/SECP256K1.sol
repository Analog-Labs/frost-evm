...
library SECP256K1 {
    ...
    uint256 internal constant n = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFC2F;
    uint256 internal constant a = 0;
    uint256 internal constant b = 7;

    function _jAdd(uint256 x1, uint256 z1, uint256 x2, uint256 z2) internal pure returns (uint256 x3, uint256 z3) {
        (x3, z3) = (addmod(mulmod(z2, x1, n), mulmod(x2, z1, n), n), mulmod(z1, z2, n));
    }

    function _jSub(uint256 x1, uint256 z1, uint256 x2, uint256 z2) internal pure returns (uint256 x3, uint256 z3) {
        (x3, z3) = (addmod(mulmod(z2, x1, n), mulmod(n - x2, z1, n), n), mulmod(z1, z2, n));
    }

    function _jMul(uint256 x1, uint256 z1, uint256 x2, uint256 z2) internal pure returns (uint256 x3, uint256 z3) {
        (x3, z3) = (mulmod(x1, x2, n), mulmod(z1, z2, n));
    }

    function _jDiv(uint256 x1, uint256 z1, uint256 x2, uint256 z2) internal pure returns (uint256 x3, uint256 z3) {
        (x3, z3) = (mulmod(x1, z2, n), mulmod(z1, x2, n));
    }

    function _inverse(uint256 val) internal pure returns (uint256 invVal) {
        uint256 t = 0;
        uint256 newT = 1;
        uint256 r = n;
        uint256 newR = val;
    ...
    function _ecDouble(uint256 x1, uint256 y1, uint256 z1) internal pure returns (uint256 x3, uint256 y3, uint256 z3) {
    ...
    function ecmul(uint256 x1, uint256 y1, uint256 scalar) internal pure returns (uint256 x2, uint256 y2) {
        uint256 z;
    ...
    function point_hash(uint256 px, uint256 py) internal pure returns (address) {
     ...
     * hash(g^a + B^c)
     */
    function sbmul_add_mul(uint256 s, uint256 bx, uint256 by, uint256 c) internal pure returns (address) {
        uint256 Q = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141;
        s = (Q - s) % Q;
        s = mulmod(s, bx, Q);

        return ecrecover(bytes32(s), by % 2 != 0 ? 28 : 27, bytes32(bx), bytes32(mulmod(c, bx, Q)));
    }
    ...
    function publicKey(uint256 privKey) internal pure returns (uint256 qx, uint256 qy) {
    ...
    function deriveKey(uint256 privKey, uint256 pubX, uint256 pubY) internal pure returns (uint256 qx, uint256 qy) {
        uint256 z;
